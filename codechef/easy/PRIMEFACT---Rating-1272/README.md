...
Determine the  **minimum**  time in seconds, after which his score becomes $\geq Y$.
...
For each test case, output the  **minimum**  time in seconds, after which Chef's score becomes $\geq Y$.
...
- Similarly, each time the score would be increased by $2$. Thus, after $11$ seconds, the score becomes $24$, which is $\geq 23$.
...
Thus, after $5$ seconds, the score becomes $20$, which is $\geq 20$.
...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-08-13T09:25:48.790Z  
...
[View on CodeChef](https://www.codechef.com/problems/PRIMEFACT)